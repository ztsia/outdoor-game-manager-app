...
import { Trash2, Loader2, RotateCcw, Bold, Italic, List, Heading } from 'lucide-react'
...
export function TerritoryModal({
    ...
    const insertMarkdown = (prefix, suffix = '') => {
        const textarea = document.getElementById('description-md')
        if (!textarea) return
            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        {/* Stars */}
                        <div className="space-y-2">
                            <Label>Stars (1-3)</Label>
                            <ToggleGroup
                                type="single"
                                value={String(stars)}
                                onValueChange={(val) => val && setStars(parseInt(val, 10))}
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="description-md">Game Rules (Markdown)</Label>
                            ...
                            <Textarea
                                ...
                                placeholder="## Rules&#10;&#10;First to score 2 goals wins!&#10;&#10;### Gameplay&#10;1. Each team takes turns&#10;2. Standard rules apply"
                                rows={6}
